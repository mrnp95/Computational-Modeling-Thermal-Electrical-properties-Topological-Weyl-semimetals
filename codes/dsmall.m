...
consig=-1;                      %conventional nernst contribution for sigxy
conalp=1;                      %conventional nernst contribution for alpxy
bersig=1;                      %berry phase nernst contribution for sigxy
beralp=1;                      %berry phase nernst contribution for alpxy
...
for z=1:Nz
   for x=1:Nx
    for y=1:Ny
      ...
      sxy3(z,x,y)=consig*((charge*tau^2*B/h)*(-df3dE3(z+1,x+1,y+1))*(vx3(z,x,y)^2*vyovyo3(z,x,y)-vx3(z,x,y)*vy3(z,x,y)*vxovyo3(z,x,y)))+bersig*berry3(z,x,y)*f3(z+1,x+1,y+1);
      ...
      sxy4(z,x,y)=consig*((charge*tau^2*B/h)*(-df4dE4(z+1,x+1,y+1))*(vx4(z,x,y)^2*vyovyo4(z,x,y)-vx4(z,x,y)*vy4(z,x,y)*vxovyo4(z,x,y)))+bersig*berry4(z,x,y)*f4(z+1,x+1,y+1);
...
for z=1:Nz
   for x=1:Nx
    for y=1:Ny
      ...
      axy3(z,x,y)=conalp*((charge*tau^2*B/(T*kbolz*h))*(E3(z+1,x+1,y+1)-mu)*(-df3dE3(z+1,x+1,y+1))*(vx3(z,x,y)^2*vyovyo3(z,x,y)-vx3(z,x,y)*vy3(z,x,y)*vxovyo3(z,x,y)))+beralp*berry3(z,x,y)*sf3(z+1,x+1,y+1);
      ...
      axy4(z,x,y)=conalp*((charge*tau^2*B/(T*kbolz*h))*(E4(z+1,x+1,y+1)-mu)*(-df4dE4(z+1,x+1,y+1))*(vx4(z,x,y)^2*vyovyo4(z,x,y)-vx4(z,x,y)*vy4(z,x,y)*vxovyo4(z,x,y)))+beralp*berry4(z,x,y)*sf4(z+1,x+1,y+1);
