...
maxB=140;                             %max value of B
minB=1;                              % min value of B
noofB=15;                              %no of values of B 
zman=linspace(minB,maxB,noofB);

Tnernst=zeros(noofB,1);
B=zeros(noofB,1);
bz=zeros(noofB,1);
...
for  magfld =1:noofB;
    B(magfld)=zman(magfld);
    bz=5.8025*10^-5*B(magfld);
...
for z=1:Nz
   for x=1:Nx
    for y=1:Ny
      %sxy1(z,x,y)=((charge*tau^2*B)*(-df1dE1(z+1,x+1,y+1))*(vx1(z,x,y)^2*vyovyo1(z,x,y)-vx1(z,x,y)*vy1(z,x,y)*vxovyo1(z,x,y)))+berry1(z,x,y)*f1(z+1,x+1,y+1);
      ...
      %sxy2(z,x,y)=((charge*tau^2*B)*(-df2dE2(z+1,x+1,y+1))*(vx2(z,x,y)^2*vyovyo2(z,x,y)-vx2(z,x,y)*vy2(z,x,y)*vxovyo2(z,x,y)))+berry2(z,x,y)*f2(z+1,x+1,y+1);
      ...
      %sxy3(z,x,y)=((charge*tau^2*B)*(-df3dE3(z+1,x+1,y+1))*(vx3(z,x,y)^2*vyovyo3(z,x,y)-vx3(z,x,y)*vy3(z,x,y)*vxovyo3(z,x,y)))+berry3(z,x,y)*f3(z+1,x+1,y+1);
      ...
      %sxy4(z,x,y)=((charge*tau^2*B)*(-df4dE4(z+1,x+1,y+1))*(vx4(z,x,y)^2*vyovyo4(z,x,y)-vx4(z,x,y)*vy4(z,x,y)*vxovyo4(z,x,y)))+berry4(z,x,y)*f4(z+1,x+1,y+1);
...
for z=1:Nz
   for x=1:Nx
    for y=1:Ny
      %axy1(z,x,y)=((charge*tau^2*B/(T*kbolz))*(E1(z+1,x+1,y+1)-mu)*(-df1dE1(z+1,x+1,y+1))*(vx1(z,x,y)^2*vyovyo1(z,x,y)-vx1(z,x,y)*vy1(z,x,y)*vxovyo1(z,x,y)))+berry1(z,x,y)*sf1(z+1,x+1,y+1);
      ...
      %axy2(z,x,y)=((charge*tau^2*B/(T*kbolz))*(E2(z+1,x+1,y+1)-mu)*(-df2dE2(z+1,x+1,y+1))*(vx2(z,x,y)^2*vyovyo2(z,x,y)-vx2(z,x,y)*vy2(z,x,y)*vxovyo2(z,x,y)))+berry2(z,x,y)*sf2(z+1,x+1,y+1);
      ...
      %axy3(z,x,y)=((charge*tau^2*B/(T*kbolz))*(E3(z+1,x+1,y+1)-mu)*(-df3dE3(z+1,x+1,y+1))*(vx3(z,x,y)^2*vyovyo3(z,x,y)-vx3(z,x,y)*vy3(z,x,y)*vxovyo3(z,x,y)))+berry3(z,x,y)*sf3(z+1,x+1,y+1);
      ...
      %axy4(z,x,y)=((charge*tau^2*B/(T*kbolz))*(E4(z+1,x+1,y+1)-mu)*(-df4dE4(z+1,x+1,y+1))*(vx4(z,x,y)^2*vyovyo4(z,x,y)-vx4(z,x,y)*vy4(z,x,y)*vxovyo4(z,x,y)))+berry4(z,x,y)*sf4(z+1,x+1,y+1);
...
for r=1:noofB
    Bp(r)=-B(noofB+1-r)/10;
    Tnernstp(r)=-Tnernst(noofB+1-r);
end
for r=noofB+1:2*noofB
    Bp(r)=B(r-noofB)/10;
    Tnernstp(r)=Tnernst(r-noofB);
end 
plot(Bp,Tnernstp)
hold on
s=s+1;
