...
%plot of kz vs E
nz=NZ;
plot(kz1(nz/2,:,nz/2),E11(nz/2,:,nz/2))
hold on
plot(kz1(nz/2,:,nz/2),E12(nz/2,:,nz/2),'r')
hold on
...
%surf of kz,kx vs E  
nz=NZ;
surf(kz1(:,:,nz/2),kx1(:,:,nz/2),E11(:,:,nz/2))
hold on
surf(kz1(:,:,nz/2),kx1(:,:,nz/2),E12(:,:,nz/2))
hold on
...
%plot of E vs f
nz=NZ;
plot(E11(nz/2,:,nz/2),f11(nz/2,:,nz/2))
hold on
plot(E12(nz/2,:,nz/2),f12(nz/2,:,nz/2),'r')
hold on
plot(E21(nz/2,:,nz/2),f21(nz/2,:,nz/2),'g')
hold on
plot(E22(nz/2,:,nz/2),f22(nz/2,:,nz/2),'y')
 
%%
%plot of E vs sf
nz=NZ;
plot(E11(nz/2,:,nz/2),sf11(nz/2,:,nz/2))
hold on
plot(E12(nz/2,:,nz/2),sf12(nz/2,:,nz/2),'r')
hold on
plot(E21(nz/2,:,nz/2),sf21(nz/2,:,nz/2),'g')
hold on
plot(E22(nz/2,:,nz/2),sf22(nz/2,:,nz/2),'y')
...
%plot of kz vs berry
nz=NZ;
plot(KZ1(nz/2,:,nz/2),berry11(nz/2,:,nz/2))
hold on
plot(KZ1(nz/2,:,nz/2),berry12(nz/2,:,nz/2),'r')
hold on
plot(KZ2(nz/2,:,nz/2),berry21(nz/2,:,nz/2),'g')
hold on
plot(KZ2(nz/2,:,nz/2),berry22(nz/2,:,nz/2),'y')

%%
%plot of kx vs berry
nz=NZ;
plot(KX1(:,nz/2,nz/2),berry11(:,nz/2,nz/2))
hold on
plot(KX1(:,nz/2,nz/2),berry12(:,nz/2,nz/2),'r')
hold on
plot(KX2(:,nz/2,nz/2),berry21(:,nz/2,nz/2),'g')
hold on
plot(KX2(:,nz/2,nz/2),berry22(:,nz/2,nz/2),'y')

 
%%
%surf of kz,kx vs berry
nz=NZ;
surf(KZ1(:,:,nz/2),KX1(:,:,nz/2),berry11(:,:,nz/2))
hold on
surf(KZ1(:,:,nz/2),KX1(:,:,nz/2),berry12(:,:,nz/2))
hold on
surf(KZ2(:,:,nz/2),KX2(:,:,nz/2),berry21(:,:,nz/2))
hold on
surf(KZ2(:,:,nz/2),KX2(:,:,nz/2),berry22(:,:,nz/2))
...
hold on
plot(KZ2(nz/2,:,nz/2),sxy21(nz/2,:,nz/2),'g')
hold on
